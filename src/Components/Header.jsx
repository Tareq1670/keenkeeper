...
const Header = () => {
    return (
        <div className="max-w-[1110px] mx-auto mt-[50px] sm:[60px]  md:mt-[70px] lg:mt-[80px] mb-[20px] md:mb-[40px] flex items-center justify-center flex-col text-center px-1 md:px-0">
            <h2 className="text-4xl md:text-[48px] text-[#1f2937FF] font-bold mb-2 md:mb-4">Friends to keep close in your life</h2>
            <p className="text-[#64748bFF] w-full lg:max-w-[50%] mb-6 md:mb-8">
